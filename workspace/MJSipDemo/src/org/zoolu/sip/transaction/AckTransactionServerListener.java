...
/** A AckTransactionServerListener listens for AckTransactionServer onAckSrvTimeout(AckTransactionServer) events.
  */
...
{  
   ...
   //public void onAckSrvTerminated(Transaction transaction);
}
