...
public class JMediaReceiver implements ControllerListener {
	...
	public JMediaReceiver(String media_type, int port,
			JMediaReceiverListener listener) {
	...
	public synchronized void controllerUpdate(ControllerEvent event) {
		if (ctr_listener != null)
			ctr_listener.controllerUpdate(event);
	}
	...
	public static void main(String[] args) {
		if (args.length >= 2)
			try {
				...
				JMediaReceiver media_receiver = new JMediaReceiver(args[0],
						port, null);
