...
public abstract class VideoStream extends MediaStream {
	 ...
	 * method at any time and changes will take effect next time you call
	 * {@link #prepare()}.
	 * 
	 * @param camera
	 *            Can be either CameraInfo.CAMERA_FACING_BACK or
	 ...
	 * time and changes will take effect next time you call {@link #prepare()}.
	 ...
	 * 
	 * @param bitrate
	 *            Bitrate of the stream in bit per second
	 */
	...
	/**
	 * Prepare the VideoStream, you can then call {@link #start()}. The
	 * underlying Camera will be opened and configured when you call this method
	 * so don't forget to deal with the RuntimeExceptions ! Camera.open,
	 * Camera.setParameter, Camera.unlock may throw one !
	 */
	@SuppressLint("NewApi")
	public void prepare() throws IllegalStateException, IOException {
		...
		// If an exception is thrown after the camera was open, we must
		// absolutly release it !
		try {
			...
			if (mFlashState) {
				if (parameters.getFlashMode() == null) {
					...
					parameters
							.setFlashMode(mFlashState ? Parameters.FLASH_MODE_TORCH
	...
	/**
	 * Releases ressources associated with the {@link VideoStream}. The object
	 * can't be reused once this function has been called.
	 **/
	public void release() {
		stop();
		super.release();
